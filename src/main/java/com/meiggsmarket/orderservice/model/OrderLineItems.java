...
@Table(name = "order_line_items")  // Especifica que esta entidad se mapeará a la tabla "order_line_items".
...
public class OrderLineItems {
    ...
    private String skuCode;  // Código SKU (Stock Keeping Unit) del ítem, que identifica el producto.
